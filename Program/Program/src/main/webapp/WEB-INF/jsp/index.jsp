...
<div class="form-w3ls">
    ...
    <ul class="tab-group cl-effect-4">
        <li class="tab active"><a href="#signin-agile">Customer</a></li>
		<li class="tab"><a href="#signup-agile">Merchant</a></li>        
    </ul>
    <div class="tab-content">
        <div id="signin-agile">   
			<form action="http://localhost:8066/login.jsp
			" method="post">
				...
				<input type="email" name="userId" placeholder="Your email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Full Name';}" required="required">
    ...
    <label for="female" class="radio">Female</label>
			 ...
			 <p>Already have an account? <a href="http://localhost:8053/login">Sign IN</a>.</p>
		</div>
		<div id="signup-agile">   
			<form action="login.jsp" method="post">
				...
				<input type="text" name="status" placeholder="Your status" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Your Status';}" required="required">
